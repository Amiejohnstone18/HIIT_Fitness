...
* On every page there is a badge displayed top- left which says *"Sign up for £24.99"*, a click of this button will take the user to the sign-up form. In addition to this, the navigation menu displays a *"Sign up"* option containing all relevant information. 
